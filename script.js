...
//preload loads all the game assets
    ...
    create(){
        ...
        this.text= this.add.text(300, 500, 'USE LEFT, RIGHT AND DOWN TO MOVE AND GRAVITY WILL DO THE REST!', { fill: '#B5E61D' }).setScale(2);
...
create() {
    ...
    //this.text= this.add.text(100, 300, 'I dont think theyve realised yet...', {fill:'#ffffff'});
